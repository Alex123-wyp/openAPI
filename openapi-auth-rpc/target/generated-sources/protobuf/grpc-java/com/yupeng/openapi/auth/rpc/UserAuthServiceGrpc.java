...
public final class UserAuthServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.yupeng.openapi.auth.rpc.GetUserAuthByAccessKeyRequest,
      com.yupeng.openapi.auth.rpc.GetUserAuthByAccessKeyResponse> getGetUserAuthByAccessKeyMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetUserAuthByAccessKey",
      requestType = com.yupeng.openapi.auth.rpc.GetUserAuthByAccessKeyRequest.class,
      responseType = com.yupeng.openapi.auth.rpc.GetUserAuthByAccessKeyResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.yupeng.openapi.auth.rpc.GetUserAuthByAccessKeyRequest,
      com.yupeng.openapi.auth.rpc.GetUserAuthByAccessKeyResponse> getGetUserAuthByAccessKeyMethod() {
    io.grpc.MethodDescriptor<com.yupeng.openapi.auth.rpc.GetUserAuthByAccessKeyRequest, com.yupeng.openapi.auth.rpc.GetUserAuthByAccessKeyResponse> getGetUserAuthByAccessKeyMethod;
      ...
      synchronized (UserAuthServiceGrpc.class) {
        if ((getGetUserAuthByAccessKeyMethod = UserAuthServiceGrpc.getGetUserAuthByAccessKeyMethod) == null) {
          UserAuthServiceGrpc.getGetUserAuthByAccessKeyMethod = getGetUserAuthByAccessKeyMethod =
              io.grpc.MethodDescriptor.<com.yupeng.openapi.auth.rpc.GetUserAuthByAccessKeyRequest, com.yupeng.openapi.auth.rpc.GetUserAuthByAccessKeyResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetUserAuthByAccessKey"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yupeng.openapi.auth.rpc.GetUserAuthByAccessKeyRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.yupeng.openapi.auth.rpc.GetUserAuthByAccessKeyResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void getUserAuthByAccessKey(com.yupeng.openapi.auth.rpc.GetUserAuthByAccessKeyRequest request,
        io.grpc.stub.StreamObserver<com.yupeng.openapi.auth.rpc.GetUserAuthByAccessKeyResponse> responseObserver) {
  ...
  public static final class UserAuthServiceStub
    ...
    /**
     */
    public void getUserAuthByAccessKey(com.yupeng.openapi.auth.rpc.GetUserAuthByAccessKeyRequest request,
        io.grpc.stub.StreamObserver<com.yupeng.openapi.auth.rpc.GetUserAuthByAccessKeyResponse> responseObserver) {
  ...
  public static final class UserAuthServiceBlockingStub
    ...
    /**
     */
    public com.yupeng.openapi.auth.rpc.GetUserAuthByAccessKeyResponse getUserAuthByAccessKey(com.yupeng.openapi.auth.rpc.GetUserAuthByAccessKeyRequest request) {
  ...
  public static final class UserAuthServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.yupeng.openapi.auth.rpc.GetUserAuthByAccessKeyResponse> getUserAuthByAccessKey(
        com.yupeng.openapi.auth.rpc.GetUserAuthByAccessKeyRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_USER_AUTH_BY_ACCESS_KEY:
          serviceImpl.getUserAuthByAccessKey((com.yupeng.openapi.auth.rpc.GetUserAuthByAccessKeyRequest) request,
              (io.grpc.stub.StreamObserver<com.yupeng.openapi.auth.rpc.GetUserAuthByAccessKeyResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.yupeng.openapi.auth.rpc.GetUserAuthByAccessKeyRequest,
              com.yupeng.openapi.auth.rpc.GetUserAuthByAccessKeyResponse>(
